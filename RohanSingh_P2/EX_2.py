...
def main():
    ...
    df = pd.read_csv("RohanSingh_P2/irisdata.csv")
    ...
    #Part (e) getting the results for examples from the iris class
    test_set = np.array([[3.5,1.0],[3.9,1.1],[3.8,1.1],[4.7,1.5],[6.0,2.5],[6.9,2.3],[5.1,1.8],[6.1,1.9]])
    test_results = predict(test_set,w,b)
