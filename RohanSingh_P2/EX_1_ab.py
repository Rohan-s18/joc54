...
# Source code for K-means clustering this is the source code for Excercise 1 parts (a) and (b)
...
class KMeans:
    ...
    def __init__(self, k=3, max_iter=100,df=pd.read_csv("RohanSingh_P2/irisdata.csv")):
        self.k = k
